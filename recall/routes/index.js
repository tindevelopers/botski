...
import apiDebugMsOauth from "./api/debug-ms-oauth.js";
...
import apiIngestExternalMeeting from "./api/ingest-external-meeting.js";
...
router.get("/api/debug/ms-oauth", apiDebugMsOauth);
...
router.post("/api/ingest-external-meeting", apiIngestExternalMeeting);
